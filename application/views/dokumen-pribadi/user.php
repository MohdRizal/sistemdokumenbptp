...
$bc[] = ['label' => 'Dokumen Pribadi', 'url' => '', 'class' => 'active'];
                        ...
                        <tbody>
                            ...
                            foreach($user as $d): 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('personal-document/all/'.$d['id_user']) ?>" class="btn bg-green waves-effect" title="Edit Data"><i class="material-icons">search</i></a>
                                    </td>
                                </tr>
                                <?php 
                                $no++;
