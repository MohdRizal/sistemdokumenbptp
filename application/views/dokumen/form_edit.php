<?php
$title = 'Update '.$detail['jenis_dokumen'];
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="card">
            ...
            <div class="body">
                <form action="<?= base_url('dokumen/update/type/') ?><?= $data['id_dokumen'] ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <input type="number" name="tahun_dokumen" class="form-control" value="<?= $data['tahun_dokumen'] ?>" min="1945" max="<?= date('Y') ?>">
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <label>Ringkasan</label>
                            <textarea rows="4" name="ringkasan" class="form-control no-resize" required><?= $data['ringkasan'] ?></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <label>File (yang diizinkan : PDF, DOC / DOCX, PPT / PPTX) dengan ukuran maksimum 10 MB</label>
                            <input type="file" name="dokumen" class="form-control no-resize">  
                            <?= $data['lokasi'] ?>                     
                        </div>
                    </div>
